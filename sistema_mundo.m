...
patch('Faces',faces_piramide,'Vertices',piramide_mundo,'FaceColor','r');
...
patch('Faces',faces_paralelepipedo,'Vertices',paralelepipedo_mundo,'FaceColor','m');
...
patch('Faces',faces_tronco,'Vertices',tronco_mundo,'FaceColor','g');
